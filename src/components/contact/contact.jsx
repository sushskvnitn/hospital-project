  ...
  return (
    ...
    <div className="contact2 marn-top" >
      ...
      <div className="d-flex justify-content-center" >
        <iframe title="map" className="map d-lg-none" src="https://goo.gl/maps/w9T7CkckuVswVTS49" width="390" height="400" style={{border:"0"}} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
