  ...
  return (
    ...
    <div className="contact2 marn-top" >
      ...
      <div className="d-flex justify-content-center" >
        <iframe title="map" className="map d-lg-none" src="https://goo.gl/maps/QPMwkt9U7fHiV9Qz5" width="390" height="400" style={{border:"0"}} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
        <iframe title="map" className="map d-none d-lg-block" src="https://goo.gl/maps/QPMwkt9U7fHiV9Qz5" width="1500" height="500" style={{border:"0"}} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
      </div>
